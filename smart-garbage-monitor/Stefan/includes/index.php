...
<body>
    <div id="background">
            ...
            <div align="middle">
                ...
                <div class="dropdown">
                    <div class="dropbtn">Luna
                        <div class="dropdown-content">
                            <button class="dropbtn" name="luna" value="May">May</button>
                            <button class="dropbtn" name="luna" value="April"> April </button>
                            <button class="dropbtn" name="luna" value="March">March </button>
                        </div>
                    </div>
                </div>
            </div>
        ...
        if(isset($_GET['luna']))
        {
            ...
            $json2=[];
            $json2[]="Hartie";//am trei bare, de aceea trebuie sa punem de 3 ori luna
            $json2[]="Sticla";
            $json2[]="Menajer";
